...
void lv_app_scroll(void)
{
    ...
    // menu_item_create(cont, &label_style, event_handler, &authority, "#000000 时钟#",NULL);
    // menu_item_create(cont, &label_style, event_handler, &cloud, "#000000 天气#", NULL);
    // menu_item_create(cont, &label_style, event_handler, &pending, "#000000 课程表#", NULL);
    // menu_item_create(cont, &label_style, event_handler, &observation, "#000000 电脑性能#", NULL);
    // menu_item_create(cont, &label_style, event_handler, &wireless, "#000000 无线配网#", NULL);
    // menu_item_create(cont, &label_style, event_handler, &alert, "#000000 屏幕亮度#", NULL);
    // menu_item_create(cont, &label_style, event_handler, &copy, "#000000 扩展功能#", NULL);
